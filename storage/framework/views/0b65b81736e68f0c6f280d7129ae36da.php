...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'কুরআন পাবলিশিং সফটওয়্যার'); ?></title>
    ...
    <style>
        @font-face {
            ...
            src: url('<?php echo e(asset('fonts/ExcellentArabicWeb2.0.ttf')); ?>') format('truetype');
            font-weight: normal;
            font-style: normal;
    ...
    <link rel="preload" href="<?php echo e(asset('fonts/ExcellentArabicWeb2.0.ttf')); ?>" as="font" type="font/ttf" crossorigin>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('css/quran-editor.css')); ?>">

    <?php echo $__env->yieldPushContent('head'); ?>
    <script>
        // Inject Laravel APP_URL so static JS files can build correct paths under any subfolder
        window.APP_BASE = '<?php echo e(rtrim(config('app.url'), '/')); ?>';
    </script>
</head>
<body>
    <!-- Top Navigation Bar -->
    <header class="app-header" id="app-header">
        ...
        <div class="header-center">
            <nav class="header-nav">
                <a href="<?php echo e(route('editor')); ?>" class="nav-link <?php echo e(request()->routeIs('editor') ? 'active' : ''); ?>">
    ...
    <script src="<?php echo e(asset('js/quran-editor.js')); ?>?v=<?php echo e(filemtime(public_path('js/quran-editor.js'))); ?>"></script>

    <?php echo $__env->yieldPushContent('scripts'); ?>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\Quran Project\quran-publisher\resources\views/layouts/app.blade.php ENDPATH**/ ?>